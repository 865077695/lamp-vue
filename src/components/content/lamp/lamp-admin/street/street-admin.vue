...
<template>
  <div>
    <!-- 搜索 -->
    <div class="search">
      <my-form class="searchForm" ref="searchForm" :formItems="streetListSearchItem" :formData="streetSearchParams" @validaok="searchOk"></my-form>
    ...
    <Modal v-model="addModal" width="360">
      ...
      <div style="height: 400px;">
        <my-form ref="addForm" :formItems="addStreetItem" :formData="addStreetData" :formRule="addStreetFormRule" @validaok="addOk"></my-form>
      </div>
      <div slot="footer">
...
export default {
  ...
  methods: {
    ...
    addOk() {
      ...
      this.adding = true;
      http({
        url: "street/streetsAdd",
        method: "POST",
        data: this.addStreetData
      }).then(res => {
        if (res.code === 200) {
          this.adding = false;
          this.addModal = false;
    ...
    getStreetsList() {
      ...
      http({
        url: "street/streetsList",
        method: "POST",
        data: this.streetSearchParams
      }).then(res => {
